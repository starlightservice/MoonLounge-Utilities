...
client.on("messageReactionAdd", async (reaction, user) => {
    ...
    Schema.findOne({ Message: reaction.message.id }, async (err, data) => {
        ...
        user.send(`**${reaction.message.guild.name}:** You've have been verified as **${dmRole}** role has been added!`).catch(err => {
...
client.on("messageReactionRemove", async (reaction, user) => {
    ...
    Schema.findOne({ Message: reaction.message.id }, async (err, data) => {
        ...
        user.send(`**${reaction.message.guild.name}:** You've lost your **${dmRole}** verified role!`).catch(err => {
